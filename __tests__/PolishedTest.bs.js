...
Jest.test("rgb", (function (param) {
        ...
        return Jest.Expect.toBe("#fff", Jest.Expect.expect(Curry._1(Polished.Color.rgb, rgb)));
      }));
...
Jest.test("rgba", (function (param) {
        ...
        return Jest.Expect.toBe("rgba(255,205,100,0.7)", Jest.Expect.expect(Curry._1(Polished.Color.rgba, rgba)));
      }));
