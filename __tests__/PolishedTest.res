...
describe("Color", () => {
  ...
  test("hsl", () => {
    hsl(~hue=30., ~saturation=0.5, ~lightness=0.3)
    -> expect
    |> toBe("#734d26")
  })
  ...
  test("meetsContrastGuidelines", () => {
    ...
    ("#000000")
    -> meetsContrastGuidelines("#ffffff")
    -> expect
    |> toEqual(expected)
  })
  ...
  test("readableColor", () => {
    ...
    "black"
    -> readableColor(~darkReturnColor="#ff8", ())
    -> expect
    |> toBe("#ff8")
    |> keepGoing

    "white"
    -> readableColor(~lightReturnColor="#001", ())
    -> expect
    |> toBe("#001")
    |> keepGoing
